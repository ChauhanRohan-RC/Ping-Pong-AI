...
class DifficultyLevel:
    ...
    def __init__(self, _id: int, key: str, display_name: str,
        ...
        self.paddle_rel_width: float = to_rel(max(to_abs(paddle_rel_width), to_abs(get_vel_max_total(self.ball_rel_vel_max_component)) + 4))
...
DIFFICULTY_LEVEL_EASY = DifficultyLevel(_id=0xAAA0, key="EASY", display_name="Easy",
                                        paddle_rel_width=0.0087, paddle_rel_height=0.138, paddle_rel_vel=0.0086,
                                        ball_rel_radius=0.01, ball_rel_vel_max_component=0.00725,
                                        ball_reset_delay_secs=2.5, ball_random_initial_vel_enabled=False,
...
DIFFICULTY_LEVEL_NORMAL = DifficultyLevel(_id=0xAAA1, key="NORMAL", display_name="Normal",
                                          paddle_rel_width=0.00875, paddle_rel_height=0.11875, paddle_rel_vel=0.0082,
                                          ball_rel_radius=0.008, ball_rel_vel_max_component=0.00755,
                                          ball_reset_delay_secs=2, ball_random_initial_vel_enabled=False,
...
DIFFICULTY_LEVEL_HARD = DifficultyLevel(_id=0xAAA2, key="HARD", display_name="Hard",
                                        paddle_rel_width=0.009, paddle_rel_height=0.1, paddle_rel_vel=0.008,
...
DIFFICULTY_LEVEL_EXPERT = DifficultyLevel(_id=0xAAA3, key="EXPERT", display_name="Expert",
                                          paddle_rel_width=0.01125, paddle_rel_height=0.0925, paddle_rel_vel=0.008,
